...
var TerminalVerdict = map[string][]string{
	...
	"CodeForces":    {"Accepted", "Wrong answer", "Time limit exceeded", "Memory limit exceeded", "Runtime error", "Compilation error", "Source Code Error", "Language Rejected"},
	...
	"Gym":           {"Accepted", "Wrong answer", "Time limit exceeded", "Memory limit exceeded", "Runtime error", "Compilation error", "Source Code Error", "Language Rejected"},
